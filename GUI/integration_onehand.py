...
def cv_gui_arduino(p_list, maximum,):
    """
        ...
        def select_mode(self, select_idx):
            ...
            for right in self.right:
                if right == 1:
                    right_idx_1 += 1
            if select_idx < 0:
                if right_idx_1 > 55 and mode_global == 0:
                    mode_global = 1
                    print('mode 1')
                    select_idx = 50 * 30
                elif right_idx_1 < 55 and mode_global == 1:
                    mode_global = 0
                    print('mode 0')
            select_idx -= 1
            return select_idx
    ...
    class opcv(QThread):
        ...
        change_pixmap_signal_2 = pyqtSignal(int)
        ...
        def run(self):  # p를 보는 emit 함수
            ...
            prevTime = 0
            command_status = 3
            gesture_list = [3 for _ in range(7)]
            enter_mode = Enter_mode()

            select_idx = 1

            self.change_pixmap_signal_2.emit(0)
            ...
            while self.bool_state and cap.isOpened():
                ...
                if results.multi_hand_landmarks:
                    ...
                    if mode_global:
                        self.change_pixmap_signal_2.emit(1)
                ...
                if det_duration > 60 :
                    self.change_pixmap_signal.emit(cv2.cvtColor(cv2.imread('Image_onehand/wating_screen.png'), cv2.COLOR_BGR2RGB))
                else :
            ...
            try:
                ...
                pass
            self.change_pixmap_signal.emit(cv2.cvtColor(cv2.imread('Image_onehand/touch_mode_screen.png'), cv2.COLOR_BGR2RGB))
            hands.close()
    ...
    class Ui_MainWindow(QtWidgets.QMainWindow):
        ...
        def setupUi(self, MainWindow):
            ...
            self.pushButton.setStyleSheet(
                '''
                QPushButton{image:url(./Image_onehand/모션제어.png); border:0px;}
                QPushButton:checked{image:url(./Image_onehand/모션제어_checked.png); border:0px;}
                ''')
            ...
            self.pushButton_2.setStyleSheet(
                '''
                QPushButton{image:url(./Image_onehand/터치제어.png); border:0px;}
                QPushButton:checked{image:url(./Image_onehand/터치제어_checked.png); border:0px;}
                ''')
            ...
            self.label_6.setPixmap(QtGui.QPixmap("Image_onehand/gesture_before.PNG"))
            ...
            self.pushButton_3.setStyleSheet(
                '''
                QPushButton{image:url(./Image_onehand/up.png); border:0px;}
                QPushButton:checked{image:url(./Image_onehand/up_checked.png); border:0px;}
                ''')
            ...
            self.pushButton_4.setStyleSheet(
                '''
                QPushButton{image:url(./Image_onehand/stop.png); border:0px;}
                QPushButton:checked{image:url(./Image_onehand/stop_checked.png); border:0px;}
                ''')
            ...
            self.pushButton_5.setStyleSheet(
                '''
                QPushButton{image:url(./Image_onehand/down.png); border:0px;}
                QPushButton:checked{image:url(./Image_onehand/down_checked.png); border:0px;}
                ''')
            ...
            self.pushButton_6.setStyleSheet(
                '''
                QPushButton{image:url(./Image_onehand/refresh.png); border:0px;}
                QPushButton:hover{image:url(./Image_onehand/refresh_hover.png); border:0px;}
            ...
            self.pushButton_7.setStyleSheet(
                '''
                QPushButton{image:url(./Image_onehand/power.png); border:0px;}
                QPushButton:hover{image:url(./Image_onehand/power_hover.png); border:0px;}
                ''')
            ...
            self.pushButton_8.setStyleSheet(
                '''
                QPushButton{image:url(./Image_onehand/qmark.png); border:0px;}
                QPushButton:hover{image:url(./Image_onehand/qmark_hover.png); border:0px;}
                ''')
            ...
            self.thread.change_pixmap_signal_2.connect(self.change_label_6)
        ...
        def retranslateUi(self, MainWindow):
            ...
            self.label_3.setText(_translate("MainWindow", "아래의 과정을 따라"))
        ...
        @pyqtSlot(int)
        def change_label_6(self, change_pixmap_signal_2):
            if change_pixmap_signal_2 == 0 :
                self.label_6.setPixmap(QtGui.QPixmap("Image_onehand/gesture_before.PNG"))
            else :
                self.label_6.setPixmap(QtGui.QPixmap("Image_onehand/gesture_ing.PNG"))
    ...
    class Ui_Dialog(object): # 가이드 윈도우
        def setupUi(self, Dialog):
            ...
            self.label_31.setPixmap(QtGui.QPixmap("Image_onehand/guide_4.PNG"))
            self.label_31.setScaledContents(True)
            self.label_31.setObjectName("label_31")
            self.label_2 = QtWidgets.QLabel(self.frame)
            self.label_2.setGeometry(QtCore.QRect(30, 1340, 711, 291))
            self.label_2.setText("")
            self.label_2.setPixmap(QtGui.QPixmap("Image_onehand/guide_5.png"))
            self.label_2.setScaledContents(True)
            self.label_2.setObjectName("label_2")
            ...
            self.label_38.setPixmap(QtGui.QPixmap("Image_onehand/down.png"))
            ...
            self.label_14.setPixmap(QtGui.QPixmap("Image_onehand/program.png"))
            self.label_14.setScaledContents(True)
            self.label_14.setObjectName("label_14")
            self.label_22 = QtWidgets.QLabel(self.frame)
            self.label_22.setGeometry(QtCore.QRect(40, 990, 61, 61))
            self.label_22.setText("")
            self.label_22.setPixmap(QtGui.QPixmap("Image_onehand/qmark.png"))
            ...
            self.label_37.setPixmap(QtGui.QPixmap("Image_onehand/up.png"))
            ...
            self.label_21.setPixmap(QtGui.QPixmap("Image_onehand/power.png"))
            self.label_21.setScaledContents(True)
            self.label_21.setObjectName("label_21")
            self.label_39 = QtWidgets.QLabel(self.frame)
            self.label_39.setGeometry(QtCore.QRect(380, 1970, 51, 51))
            self.label_39.setText("")
            self.label_39.setPixmap(QtGui.QPixmap("Image_onehand/stop.png"))
            ...
            self.label_40.setPixmap(QtGui.QPixmap("Image_onehand/guide_3.PNG"))
            ...
            self.label_20.setPixmap(QtGui.QPixmap("Image_onehand/refresh.png"))
        ...
        def retranslateUi(self, Dialog):
            ...
            self.label_27.setText(_translate("Dialog", "영상 송출부를 통해서 제스처 인식 영상을 볼 수 있습니다. 이때, 오른손으로 보자기 동작을 1-2초"))
            self.label_35.setText(_translate("Dialog", "를 누르면, 침대의 경사가 감소합니다."))
            self.label_28.setText(_translate("Dialog", "취해야 제스처 인식이 시작됩니다."))
...
def data_predict(p_list, maximum):
    ...
    try:
        model = keras.models.load_model(
            '../model_save/my_model_63_renewal_v3.h5'
        )
    except:
        print('ML 모델 로딩 실패')
    while True:
...
if __name__ == '__main__':
    p_list = Queue(1)
    maximum = Value('i', 0)
    process1 = Process(target=cv_gui_arduino, args=(p_list, maximum,))
