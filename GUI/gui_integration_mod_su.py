...
def cv_gui_arduino(p_list, maximum, p_list_2, maximum_2):
    ...
    class Enter_mode:
        ...
        def update_left(self, left, select_idx):
        ...
        def select_mode(self, select_idx):
            ...
            if select_idx < 0:
                ...
                if right_idx_1 > 10 and mode_global == 0:
                    mode_global = 1
                    left_or_right_status = 1
                    print('mode 1')
                    ui.label_6.setPixmap(QtGui.QPixmap("Image/gesture_ing.PNG"))
                    select_idx = 30

                elif left_idx_1 > 10 and mode_global == 0:
                    mode_global = 1
                    left_or_right_status = 0
                    print('mode 1')
                    ui.label_6.setPixmap(QtGui.QPixmap("Image/gesture_ing.PNG"))
                    select_idx = 30
                ...
                elif left_idx_1 < 10 and mode_global == 1:
                    mode_global = 0
                    left_or_right_status = 2
                    print('mode 0')
                    ui.label_6.setPixmap(QtGui.QPixmap("Image/gesture_before.PNG"))
            ...
            while self.bool_state and cap.isOpened():
                ...
                if results.multi_hand_landmarks:
                    ...
                    if HM.result == [1, 1, 1, 1, 1, 1] and len(left_or_right) == 5 and HM.z_orthogonality < -0.5:
                        ...
                        select_idx = enter_mode.update_left(1, select_idx)
                    else :
                        if len(left_or_right) == 5 :
