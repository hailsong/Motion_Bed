    ...
    class Ui_MainWindow(QtWidgets.QMainWindow):
        ...
        def setupUi(self, MainWindow):
            ...
            self.pushButton_3.setStyleSheet(
                '''
                QPushButton{image:url(./Image/up_activation.png); border:0px;}
            ...
            self.pushButton_4.setStyleSheet(
                '''
                QPushButton{image:url(./Image/stop_activation.png); border:0px;}
            ...
            self.pushButton_5.setStyleSheet(
                '''
                QPushButton{image:url(./Image/down_activation.png); border:0px;}
...
#                                                self.get_finger_angle(self.pinky)])
#
#             finger_angle_threshold = np.array([2.0, 1.7, 2.2, 2.2, 2.4])
#             self.finger_state_angle = np.array(self.finger_angle_list > finger_angle_threshold, dtype=int)
#             # TODO 각 손가락 거리정보 근거로 손가락 굽힘 판단
#
#             self.finger_distance_list = np.array([get_distance(self.thumb[3], self.pinky[0]) / get_distance(self.index[0], self.pinky[0]),
...
#                                                   get_distance(self.ring[3], self.ring[0]) / get_distance(self.ring[0], self.ring[1]),
#                                                   get_distance(self.pinky[3], self.pinky[0]) / get_distance(self.pinky[0], self.pinky[1])])
#             finger_distance_threshold = np.array([1.0, 2, 2, 2, 2])
#             self.finger_state_distance = np.array(self.finger_distance_list > finger_distance_threshold, dtype=int)
#
#             # TODO 손가락과 손바닥 이용해 손가락 굽힘 판단
#             self.hand_angle_list = np.array([self.get_angle(self.thumb[1] - self._p_list[0], self.thumb[3] - self.thumb[1]),
...
#                                              self.get_angle(self.ring[0] - self._p_list[0], self.ring[3] - self.ring[0]),
#                                              self.get_angle(self.pinky[0] - self._p_list[0], self.pinky[3] - self.pinky[0])])
#             hand_angle_threshold = np.array([0.5, 1.5, 1.5, 1.5, 1.3])
#             self.hand_state_angle = np.array(self.hand_angle_list < hand_angle_threshold, dtype=int)
#             self.input = np.concatenate((self.finger_angle_list, self.finger_distance_list, self.hand_angle_list))
#             result = self.finger_state_angle + self.finger_state_distance + self.hand_state_angle > 1
#             result = result.tolist()
...
#                             handedness_list.append(results.multi_handedness[i].classification[0].label)
#                         prediction_list = [HM.MAX, HM_2.MAX]
#                         if [1, 1, 1, 1, 1, 1] in hands_list:
#                             i = hands_list.index([1, 1, 1, 1, 1, 1])
#                             left_or_right = len(handedness_list[i])
#                             orthogonality = z_orthogonality_list[i]
#                             prediction_list.pop(i)
#                             if (left_or_right == 4 and orthogonality > 0.2) or (left_or_right == 5 and orthogonality < -0.2):
...
#             filename = 'C:/Users/82102/PycharmProjects/pythonProject/GUI/TEST/' + str(now) + ".avi"
#             w, h = 640, 480
#             video = cv2.VideoWriter(filename,
#                                     self.fourcc, 10.0, (w, h))
#             while self.record:
...
#             # self.frame.setStyleSheet('background-color : rgb(224, 244, 253)') #f7f0ff
...
#             self.label_3.setGeometry(QtCore.QRect(1150,75,375,40))
#             self.label_3.setObjectName("label_3")
#             self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
#             self.groupBox.setGeometry(QtCore.QRect(1150, 285, 375, 300))
#             self.groupBox.setAlignment(QtCore.Qt.AlignCenter)
#             self.groupBox.setObjectName("groupBox")
#             self.pushButton = QtWidgets.QPushButton(self.groupBox)
#             self.pushButton.setGeometry(QtCore.QRect(20, 100, 157, 157))
...
#             self.pushButton_2.setGeometry(QtCore.QRect(197, 100, 157, 157))
...
#             self.checkBox.setGeometry(QtCore.QRect(1270, 270, 145, 34))
#             self.checkBox.setObjectName("checkBox")
#             self.checkBox.setCheckState(False)
#             self.groupBox_2 = QtWidgets.QGroupBox(self.centralwidget)
#             self.groupBox_2.setGeometry(QtCore.QRect(1150, 620, 375, 200))
#             self.groupBox_2.setAlignment(QtCore.Qt.AlignCenter)
#             self.groupBox_2.setObjectName("groupBox_2")
#             self.pushButton_3 = QtWidgets.QPushButton(self.groupBox_2)
#             self.pushButton_3.setGeometry(QtCore.QRect(30, 45, 111,111))
#             self.pushButton_3.setText("")
#             self.pushButton_3.setStyleSheet("border-radius : 55; border : 2px solid white")
#             self.pushButton_3.setStyleSheet(
#                 '''
...
#             self.pushButton_4.setGeometry(QtCore.QRect(170, 45, 111, 111))
#             self.pushButton_4.setText("")
#             self.pushButton_4.setStyleSheet("border-radius : 55; border : 2px solid white")
#             self.pushButton_4.setStyleSheet(
#                 '''
...
#             self.pushButton_5.setGeometry(QtCore.QRect(305, 110, 45, 45))
#             self.pushButton_5.setText("")
#             self.pushButton_5.setStyleSheet("border-radius : 22; border : 2px solid white")
#             self.pushButton_5.setStyleSheet(
#                 '''
#                 QPushButton{image:url(./Image/qmark.png); border:0px;}
#                 QPushButton:hover{image:url(./Image/qmark_hover.png); border:0px;}
...
#             self.pushButton_6.setGeometry(QtCore.QRect(1325, 30, 200, 50))
#             self.pushButton_6.setText("테스트용 녹화 시작")
#             self.pushButton_6.setCheckable(True)
#
#             self.label_2 = QtWidgets.QLabel(self.centralwidget)
#             self.label_2.setGeometry(QtCore.QRect(1150,150,375,100))
#             self.label_2.setText("")
#             self.label_2.setPixmap(QtGui.QPixmap("./Image/인바디.png"))
#             self.label_2.setScaledContents(True)
#             self.label_2.setObjectName("label_2")
...
#             self.pushButton_6.toggled.connect(self.recording)
#
#             self.thread = opcv()
#             self.thread_2 = touch_control()
#             self.thread_3 = test_mode()
#
#             self.record_state.connect(self.thread_3.new_record)
#             self.thread.change_pixmap_signal.connect(self.thread_3.new_frame)
#             self.thread.change_pixmap_signal.connect(self.update_img)
#
#             self.thread.is_connect.connect(self.update_text)
#             self.power_signal.connect(self.thread.new_bool_state)
#
#             self.pushButton_3.clicked.connect(self.rebooting)
#             self.increase_or_decrease.connect(self.thread_2.new_control_direction)
#             self.thread_2.is_connect_2.connect(self.update_text)
#             self.thread.start()
#             time.sleep(3)
#             Form.deleteLater()
#             # Form = None
...
#                 print(1)
#                 self.record_state.emit(True)
#                 self.thread_3.start()
#             else :
#                 self.record_state.emit(False)
#                 self.thread_3.terminate()
#
#         @pyqtSlot(int)
#         def update_text(self, connect):
#             if connect == 0 :
#                 self.label_3.setText("하드웨어 연결을 확인해주세요.")
#             else :
